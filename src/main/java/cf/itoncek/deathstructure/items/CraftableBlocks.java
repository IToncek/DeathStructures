package cf.itoncek.deathstructure.items;

import cf.itoncek.deathstructure.DeathStructure;
import cf.itoncek.deathstructure.utils.ItemBuilder;
...
public class CraftableBlocks {
    ...
    public static void initRecipes(DeathStructure plugin){
    ...
    public static void registerWoodRecipe(DeathStructure plugin){
    ...
    public static void registerObsidianRecipe(DeathStructure plugin){
    ...
    public static void registerEndFrame(DeathStructure plugin){
    ...
    public static void registerSandRecipe(DeathStructure plugin){
    ...
    public static void registerLogRecipe(DeathStructure plugin){
    ...
    public static void registerSoulSandRecipe(DeathStructure plugin){
    ...
    public static void registerEndCityRecipe(DeathStructure plugin){
    ...
    public static void registerFortressRecipe(DeathStructure plugin){
    ...
    public static void registerJunglePyramid(DeathStructure plugin){
    ...
    public static void registerPillagerOutpostRecipe(DeathStructure plugin){
