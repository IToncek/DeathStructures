package cf.itoncek.deathstructure.structure;
...
public class StructureUtil {
    ...
    public static void loadAndSlowlyPlaceCaio(String name, Location placementOrigin, int maxY,
                                              EntityType spawnersEntity, LootTable chestsLootTable, DeathStructure plugin) {
    ...
    public static void setLootTable(Chest chest, LootTable lootTable) {
        ...
        }.runTaskLater(DeathStructure.plugin, 1);
    }
